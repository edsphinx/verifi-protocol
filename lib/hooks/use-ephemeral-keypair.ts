...
export const getLocalEphemeralKeyPairs = (): StoredEphemeralKeyPairs => {
  const rawEphemeralKeyPairs =
    typeof localStorage !== "undefined"
      ? localStorage.getItem("verifi-ephemeral-key-pairs")
      : null;
  try {
...
/**
 * Validate the ephemeral key pair with the given nonce and the expiry timestamp.
 */
...
/**
 * Hook to generate and store an ephemeral key pair
 */
