...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log(
      "[API /api/markets/create] Request body:",
    ...
    if (!body.description || typeof body.description !== "string") {
      console.error(
        "[API /api/markets/create] Invalid description:",
        body.description,
      );
    ...
    if (
      !body.resolutionTimestamp ||
      typeof body.resolutionTimestamp !== "number"
    ) {
      console.error(
        "[API /api/markets/create] Invalid resolutionTimestamp:",
        body.resolutionTimestamp,
      );
      return NextResponse.json(
    ...
    if (!body.resolverAddress || typeof body.resolverAddress !== "string") {
      console.error(
        "[API /api/markets/create] Invalid resolverAddress:",
    ...
    if (!body.oracleId || typeof body.oracleId !== "string") {
      console.error(
        "[API /api/markets/create] Invalid oracleId:",
        body.oracleId,
      );
      return NextResponse.json(
    ...
    if (!body.targetAddress || typeof body.targetAddress !== "string") {
      console.error(
        "[API /api/markets/create] Invalid targetAddress:",
        body.targetAddress,
      );
      return NextResponse.json(
    ...
    if (typeof body.targetValue !== "number") {
      console.error(
        "[API /api/markets/create] Invalid targetValue:",
        body.targetValue,
      );
      return NextResponse.json(
    ...
    if (typeof body.operator !== "number") {
      console.error(
        "[API /api/markets/create] Invalid operator:",
        body.operator,
      );
      return NextResponse.json(
    ...
    console.log(
      "[API /api/markets/create] Payload built successfully:",
    ...
    console.error(
      "[API /api/markets/create] Error creating create_market payload:",
      error,
    );
