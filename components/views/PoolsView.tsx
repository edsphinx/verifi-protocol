        ...
        <CardContent className="pt-6">
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-4">
              There are no active AMM pools yet. Create one from a market detail page.
            </p>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-semibold">{pool.totalLiquidity.toFixed(2)} APT</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">24h Volume</span>
                  <span className="font-semibold">{pool.volume24h.toFixed(2)} APT</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Fee</span>
                  <span className="font-semibold">{(pool.fee / 10000).toFixed(2)}%</span>
                </div>
              </div>
            </CardContent>
          </Card>
